...
tags:
  ...
  - rebase
image:
  path: /assets/images/thumbnails/git-rebase.png
  alt: git rebase
---
## 들어가며
...
![Desktop View](/assets/images/git-rebase-1/3-way-merge.png){: width="972" height="589"}_3-way-merge_

그림으로 보면 3-way-merge의 경우 두 브랜치를 합치면서 새로운 merge commit을 남긴다.

![Desktop View](/assets/images/git-rebase-1/rebase.png){: width="972" height="589"}_rebase를 통한 머지_
...
![Desktop View](/assets/images/git-rebase-1/dirty-branch.png){: width="972" height="589"}_지저분한 브랜치_
...
![Desktop View](/assets/images/git-rebase-1/apply-recent-commit.png){: width="972" height="589"}_최신 커밋 반영_
...
![Desktop View](/assets/images/git-rebase-1/init-status.png){: width="972" height="589"}_초기상태_
...
![Desktop View](/assets/images/git-rebase-1/after-checkout.png){: width="972" height="589"}_rebase 대상 브랜치로 checkout_

![Desktop View](/assets/images/git-rebase-1/after-rebase.png){: width="972" height="589"}_main으로 rebase_
...
![Desktop View](/assets/images/git-rebase-1/find.png){: width="972" height="589"}_두 브랜치의 공통 조상 찾기_
...
![Desktop View](/assets/images/git-rebase-1/diff.png){: width="972" height="589"}_패치 생성_
...
![Desktop View](/assets/images/git-rebase-1/apply-diff.png){: width="972" height="589"}_패치 적용_

앞서 저장해 두었던 패치를 하나찍 꺼내면서 `main` 브랜치의 최신 상태를 기준으로 패치를 하나씩 재적용하게 된다. 이 과정에서 새로운 부모 커밋을 참조하는 방식으로, 새로운 커밋이 생성된다.

### 4. Fast-forward 머지

![Desktop View](/assets/images/git-rebase-1/ff-merge.png){: width="972" height="589"}_ff merge_

Rebase 이후에는 `feature/a`브랜치가 `main` 브랜치의 최신 커밋을 부모로 하고 있으므로 fast-forward 머지를 통해 rebase 과정을 마무리할 수 있다.

## Rebase 시 충돌 발생의 경우

![Desktop View](/assets/images/git-rebase-1/conflict.png){: width="972" height="589"}_충돌발생_
...
![Desktop View](/assets/images/git-rebase-1/conflict-resolve.png){: width="972" height="589"}_충돌해결_
...
![Desktop View](/assets/images/git-rebase-1/conflict-again.png){: width="972" height="589"}_충돌 재발생_

## Rebase를 이용한 브랜치 관리 전략

![Desktop View](/assets/images/git-rebase-1/branch-init.png){: width="972" height="589"}_초기 상태_
...
![Desktop View](/assets/images/git-rebase-1/rebase-with-ff.png){: width="972" height="589"}_rebase + ff_
...
![Desktop View](/assets/images/git-rebase-1/rebase-no-ff.png){: width="972" height="589"}_rebase + no-ff_
...
![Desktop View](/assets/images/git-rebase-1/rebase-with-no-ff-result.png){: width="972" height="589" .h-75}_rebase + no-ff 최종 모습_
